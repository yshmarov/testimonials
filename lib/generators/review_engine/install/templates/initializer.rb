...
ReviewEngine.configure do |config|
  ...
  # Unauthenticated read access to GET /reviews/api/testimonials and
  # /reviews/api/stats (approved + consented records only). Off = admins only.
